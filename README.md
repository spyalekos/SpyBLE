...
* 📡 **Passive BLE Scanner (Μέθοδος 3)**: Αυτόματη μετάβαση σε συνεχή παθητική ακρόαση εκπομπής πακέτων (BLE Advertisements) για ακαριαία ενημέρωση θερμοκρασίας & υγρασίας (MiBeacon 0xFE95, ATC/PVVX 0x181A, BTHome 0xFCD2).
* 🔍 **Hardware MAC Resolution**: Αυτόματος εντοπισμός και αντιστοίχιση της εσωτερικής Hardware MAC διεύθυνσης από τα πακέτα payload που εκπέμπονται, ξεπερνώντας τους περιορισμούς των Random OS Addresses στα Windows.
...
* 📡 **Κανόνας Μίας Σύνδεσης BLE (Single Connection Rule)**:
  ...
  * Βεβαιωθείτε ότι η εφαρμογή Xiaomi Home / Mi Home στο κινητό σας είναι κλειστή, ώστε η συσκευή να εκπέμπει ελεύθερα εκπομπή πακέτων που εκπέμπονται προς το SpyBLE.
* 🔋 **Μπαταρία & Εμβέλεια**:
