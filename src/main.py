            ...
            dialog_content = ft.Container(
                content=ft.Column([
                    ...
                    ft.Text(
                        ...
                        "   Συνεχής παθητική ακρόαση εκπομπής πακέτων στο παρασκήνιο (MiBeacon 0xFE95, ATC/PVVX 0x181A, BTHome 0xFCD2) για ακαριαία ενημέρωση μετρήσεων χωρίς κατανάλωση μπαταρίας.\n\n"
                    ...
                    ft.Text(
                        ...
                        "   ΚΛΕΙΣΤΕ την εφαρμογή Xiaomi Home / Mi Home στο κινητό σας τηλέφωνο. Οι συσκευές BLE επιτρέπουν μόνο μία ενεργή σύνδεση master τη φορά. Αν το κινητό είναι συνδεδεμένο με το θερμόμετρο ή το Mi Flora, η συσκευή σταματά την εκπομπή πακέτων που εκπέμπονται και δεν μπορεί να συνδεθεί στο SpyBLE.\n\n"
                        "3. Μπαταρία & Απόσταση:\n"
