            ...
            dialog_content = ft.Container(
                content=ft.Column([
                    ...
                    ft.Text(
                        ...
                        "4. Επανεκκίνηση Σάρωσης / Βρόγχος:\n"
                        "   Αν η συσκευή είναι σε εξοικονόμηση ενέργειας (sleep mode), ενεργοποιήστε το 'Ζωντανός Βρόγχος' ή πατήστε 'Σάρωση BLE'. Το Rapid Shooting Mode θα κάνει ριπές κλήσεων για να τη συνδέσει.",
                        size=12, color="#CBD5E1"
                    ),
                    ...
                    ft.Text(
                        ...
                        "• Ζωντανός Βρόγχος & Χρόνος: Ενεργοποιήστε τον αυτόματο έλεγχο και επιλέξτε ρυθμό ανανέωσης (5s έως 300s).\n"
